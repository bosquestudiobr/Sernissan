...
-- Revisar antes de aplicar em produÃ§Ã£o. Campos legados/deletados do Bubble foram omitidos do schema ativo.
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('pages', 'bTUhp', 'inicio', 'inicio', 2, '{"label": "InÃ­cio", "menu_pai": "gerenciamento", "max_nivel": "usu_rio", "show_melu_lateral": true}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('pages', 'bTUiT', 'concessionarias', 'concessionarias', 29, '{"label": "ConcessionÃ¡rias", "menu_pai": "admin", "max_nivel": "gerente_do_dom_nio", "show_melu_lateral": true}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('pages', 'bTUiX', 'usuarios', 'usuarios', 30, '{"label": "UsuÃ¡rios", "menu_pai": "admin", "max_nivel": "gerente_do_dom_nio", "show_melu_lateral": true}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('pages', 'bTUiZ', 'areas-funcoes', 'areas_funcoes', 32, '{"label": "Ãreas e funÃ§Ãµes", "menu_pai": "admin", "max_nivel": "gerente_do_dom_nio", "show_melu_lateral": true}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('pages', 'bTWnr', 'relatorios', 'relatorios', 16, '{"icon": "relatorios", "label": "RelatÃ³rios", "max_nivel": "gerente_regional", "show_melu_lateral": true}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('pages', 'bTWoh', 'competencias', 'mapa_competencias', 19, '{"icon": "competencias", "label": "CompetÃªncias", "max_nivel": "usu_rio", "show_melu_lateral": true}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('pages', '1778644117184x609648450205255400', 'habitos', 'habitos', 27, '{"label": "HÃ¡bitos", "menu_pai": "admin", "max_nivel": "gerente_do_dom_nio", "show_melu_lateral": true}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('pages', '1782358392382x682639849522307500', 'pilulas', 'pilulas', 37, '{"icon": "livro", "label": "PÃ­lulas de Conhecimento", "menu_pai": "admin", "max_nivel": "gerente_do_dom_nio", "show_melu_lateral": false}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('assunto_contato', 'bTODc', 'SugestÃ£o', 'sugest_o', 3, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('assunto_contato', 'bTODd', 'DÃºvida', 'd_vida', 4, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('calendario__semana_', '1777790278467x931290330296496800', 'TerÃ§a', 'quarta', 3, '{"ordem": 3, "sigla": "Ter"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('calendario__semana_', '1777790316692x268966797483646270', 'SÃ¡bado', 'sabado', 7, '{"ordem": 7, "sigla": "Sab"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('calibracao_opcao', 'bTXfB', 'NÃ£o', 'n_o', 3, '{"value": 0}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('calibracao_resultado_tipo', '1762659700169x517405941602266500', 'LÃ­der', 'lider', 1, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('calibracao_resultado_tipo', '1762659709441x240155736156778340', 'Auto CalibraÃ§Ã£o', 'auto_calibra__o', 2, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCI', 'Foco no Cliente', 'foco_no_cliente', 1, '{"id0": "C1", "peso": 1, "tipo": "sernissan", "numero": 1, "pergunta": "Identificou e entendeu as necessidades dos Clientes, permitindo o desenvolvimento de novas oportunidades e o fortalecimento das relaÃ§Ãµes jÃ¡ existentes?", "descricao": "Identificar e entender as necessidades dos Clientes, permitindo o desenvolvimento de novas oportunidades e o fortalecimento das relaÃ§Ãµes jÃ¡ existentes."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCJ', 'ExcelÃªncia', 'excel_ncia', 2, '{"id0": "C2", "peso": 1, "tipo": "sernissan", "numero": 2, "pergunta": "Atingiu o potencial mÃ¡ximo de resultados com qualidade de forma consistente em qualquer tipo de aÃ§Ã£o, considerando os recursos disponÃ­veis no momento?", "descricao": "Atingir o potencial mÃ¡ximo de resultados com qualidade de forma consistente em qualquer tipo de aÃ§Ã£o,  considerando os recursos disponÃ­veis no momento."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCN', 'Foco no Resultado', 'foco_no_resultado', 3, '{"id0": "C3", "peso": 1, "tipo": "sernissan", "numero": 3, "pergunta": "Planejou e executou todas as aÃ§Ãµes tendo o resultado como objetivo, com o menor gasto de tempo e recursos, gerando satisfaÃ§Ã£o para os Clientes?", "descricao": "Planejar e executar todas as aÃ§Ãµes tendo o resultado como objetivo, com o menor gasto de tempo e recursos, gerando satisfaÃ§Ã£o para os Clientes. "}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCO', 'VisÃ£o SistÃªmica', 'vis_o_sist_mica', 4, '{"id0": "C4", "peso": 1, "tipo": "sernissan", "numero": 4, "pergunta": "Enxergou o negÃ³cio como um todo e entendeu como funcionam as interaÃ§Ãµes entre processos, serviÃ§os, produtos, Clientes internos e externos?", "descricao": "Capacidade de \"ver\" o negÃ³cio como um todo e entender como funcionam as interaÃ§Ãµes entre processos, serviÃ§os, produtos, Clientes internos e externos. "}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCP', 'Disciplina', 'disciplina', 5, '{"id0": "C5", "peso": 1, "tipo": "sernissan", "numero": 5, "pergunta": "Planejou e executou com responsabilidade e qualidade qualquer tipo de aÃ§Ã£o, concentrando-se nas prioridades e no cumprimento dos prazos?", "descricao": "Planejar e executar com responsabilidade e qualidade qualquer tipo de aÃ§Ã£o, concentrando-se nas prioridades e no cumprimento dos prazos."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCT', 'Flexibilidade', 'flexibilidade', 6, '{"id0": "C6", "peso": 1, "tipo": "sernissan", "numero": 6, "pergunta": "Esteve aberto a novas ideias e possibilidades, lidou com vÃ¡rias demandas simultaneamente sem perder o foco e a energia?", "descricao": "Capacidade de estar aberto a novas ideias e possibilidades, lidando com vÃ¡rias demandas simultaneamente sem perder o foco e a energia."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCU', 'Proatividade', 'proatividade', 7, '{"id0": "C7", "peso": 1, "tipo": "sernissan", "numero": 7, "pergunta": "Teve iniciativa diante das situaÃ§Ãµes de forma antecipada, assumindo a responsabilidade nas tomadas de decisÃ£o com agilidade e ponderaÃ§Ã£o?", "descricao": "Ter iniciativa diante das situaÃ§Ãµes de forma antecipada, assumindo a responsabilidade nas tomadas de decisÃ£o com agilidade e ponderaÃ§Ã£o."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCV', 'ExecuÃ§Ã£o Operacional', 'execu__o_operacional', 8, '{"id0": "C8", "peso": 1, "tipo": "sernissan", "numero": 8, "pergunta": "Colocou em prÃ¡tica as estratÃ©gias e aÃ§Ãµes planejadas pela empresa, utilizando os conhecimentos tÃ©cnicos e recursos de forma otimizada?", "descricao": "Capacidade de colocar em prÃ¡tica as estratÃ©gias e aÃ§Ãµes planejadas pela empresa, utilizando os conhecimentos tÃ©cnicos e recursos de forma otimizada. "}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCZ', 'ComunicaÃ§Ã£o Escrita e Falada', 'comunica__o_escrita_e_falada', 9, '{"id0": "C9", "peso": 1, "tipo": "espec_fica", "numero": 1, "pergunta": "Leu e ouviu com atenÃ§Ã£o e comunicou de forma clara, efetiva e correta as ideias para os Clientes internos e externos?", "descricao": "Capacidade de ler e ouvir com atenÃ§Ã£o e de comunicar de forma clara, efetiva e correta as ideias para os Clientes internos e externos.   "}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCa', 'GestÃ£o da InformaÃ§Ã£o', 'gest_o_da_informa__o', 10, '{"id0": "C10", "peso": 1, "tipo": "espec_fica", "numero": 2, "pergunta": "Organizou os fluxos e garantiu a qualidade das informaÃ§Ãµes estratÃ©gicas e operacionais do negÃ³cio, com o objetivo de apoiar a tomada de decisÃ£o?", "descricao": "Organizar os fluxos e garantir a qualidade das informaÃ§Ãµes estratÃ©gicas e operacionais do negÃ³cio, com o objetivo de apoiar a tomada de decisÃ£o. "}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCb', 'LideranÃ§a', 'lideran_a', 11, '{"id0": "C11", "peso": 1, "tipo": "espec_fica", "numero": 3, "pergunta": "Inspirou pessoas influenciando de forma positiva comportamentos e modelos mentais, garantindo que objetivos da empresa fossem atingidos?", "descricao": "Inspirar pessoas influenciando de forma positiva comportamentos e modelos mentais, garantindo que objetivos da empresa sejam atingidos. "}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCf', 'NegociaÃ§Ã£o', 'negocia__o', 12, '{"id0": "C12", "peso": 1, "tipo": "espec_fica", "numero": 4, "pergunta": "Chegou a um acordo proporcionando ganhos e vantagens para todos os envolvidos no processo?", "descricao": "Capacidade de chegar a um acordo proporcionando ganhos e vantagens para todos os envolvidos no processo. "}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCg', 'OrganizaÃ§Ã£o e Planejamento', 'organiza__o_e_planejamento', 13, '{"id0": "C13", "peso": 1, "tipo": "espec_fica", "numero": 5, "pergunta": "Estruturou e projetou suas atividades e as de sua equipe, estabelecendo metas mensurÃ¡veis e atingÃ­veis, cumprindo-as com Ãªxito?", "descricao": "Capacidade de estruturar e projetar suas atividades e as de sua equipe, estabelecendo metas mensurÃ¡veis e atingÃ­veis, cumprindo-as com Ãªxito."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCh', 'Relacionamento Interpessoal', 'relacionamento_interpessoal', 14, '{"id0": "C14", "peso": 1, "tipo": "espec_fica", "numero": 6, "pergunta": "Lidou com outras pessoas de maneira empÃ¡tica se adequando Ã s necessidades de cada um e de cada situaÃ§Ã£o?", "descricao": "Capacidade de lidar com outras pessoas de maneira empÃ¡tica se adequando Ã s necessidades de cada um e de cada situaÃ§Ã£o."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCl', 'Trabalho em equipe', 'trabalho_em_equipe', 15, '{"id0": "C15", "peso": 1, "tipo": "espec_fica", "numero": 7, "pergunta": "Convivou com pessoas diferentes gerando cooperaÃ§Ã£o e sinergia para atingir um propÃ³sito comum?", "descricao": "Capacidade de conviver com pessoas diferentes gerando cooperaÃ§Ã£o e sinergia para atingir um propÃ³sito comum. "}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCm', 'Escuta Ativa', 'escuta_ativa', 16, '{"id0": "C16", "peso": 1, "tipo": "espec_fica", "numero": 8, "pergunta": "Ouviu atentamente a mensagem que outra pessoa esteja transmitindo, sem julgamentos e sem interrupÃ§Ãµes desnecessÃ¡rias?", "descricao": "Capacidade de ouvir atentamente a mensagem que outra pessoa esteja transmitindo, sem julgamentos e sem interrupÃ§Ãµes desnecessÃ¡rias."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCn', 'Capacidade de Transformar', 'capacidade_de_transformar', 17, '{"id0": "C17", "peso": 1, "tipo": "espec_fica", "numero": 9, "pergunta": "Provocou mudanÃ§as na forma de atuaÃ§Ã£o dos envolvidos em ambientes e situaÃ§Ãµes complexas e dinÃ¢micas?", "descricao": "Capacidade de provocar mudanÃ§as na forma de atuaÃ§Ã£o dos envolvidos em ambientes e situaÃ§Ãµes complexas e dinÃ¢micas."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCr', 'Desenvolvimento e Empoderamento', 'desenvolvimento_e_empoderamento', 18, '{"id0": "C18", "peso": 1, "tipo": "espec_fica", "numero": 10, "pergunta": "Delegou maior autonomia de decisÃ£o e responsabilidade Ã s equipes, valorizando e aproveitando ao mÃ¡ximo os seus talentos?", "descricao": "Capacidade de delegar maior autonomia de decisÃ£o e responsabilidade Ã s equipes, valorizando e aproveitando ao mÃ¡ximo os seus talentos."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCs', 'InteligÃªncia Emocional', 'intelig_ncia_emocional', 19, '{"id0": "C19", "peso": 1, "tipo": "espec_fica", "numero": 11, "pergunta": "Identificou os nossos prÃ³prios sentimentos e os dos outros, motivou-se e geriu bem as emoÃ§Ãµes dentro de nÃ³s e nos nossos relacionamentos?", "descricao": "Capacidade de identificar os nossos prÃ³prios sentimentos e os dos outros, de nos motivarmos e de gerir bem as emoÃ§Ãµes dentro de nÃ³s e nos nossos relacionamentos. "}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia', 'bTXCt', 'AnÃ¡lise de Resultados', 'an_lise_de_resultados', 20, '{"id0": "C20", "peso": 1, "tipo": "espec_fica", "numero": 12, "pergunta": "Analisou e interpretou os Indicadores e os impactos das aÃ§Ãµes realizadas, verificou tendÃªncias e planejou aÃ§Ãµes de melhoria?", "descricao": "Capacidade de analisar e interpretar os Indicadores e os impactos das aÃ§Ãµes realizadas, verificar tendÃªncias e planejar aÃ§Ãµes de melhoria."}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_atitudes', 'bTXFI', 'AtenÃ§Ã£o', 'aten__o', 3, '{"id0": "CA3"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_atitudes', 'bTXFT', 'DedicaÃ§Ã£o', 'dedica__o', 8, '{"id0": "CA8"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_atitudes', 'bTXFf', 'ResiliÃªncia', 'resili_ncia', 14, '{"id0": "CA13"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_atitudes', 'bTXFg', 'AutoconfianÃ§a', 'autoconfian_a', 15, '{"id0": "CA14"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_atitudes', 'bTXFh', 'Seguir hÃ¡bitos', 'seguir_h_bitos', 16, '{"id0": "CA15"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDD', 'Agenda de GestÃ£o', 'agenda_de_gest_o', 2, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDE', 'CalibraÃ§Ã£o de CompetÃªncias e HÃ¡bitos', 'calibra__o_de_compet_ncias_e_h_bitos', 3, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDJ', 'Guia SERNISSAN | Como realizar uma AutocalibraÃ§Ã£o consciente', 'guia_sernissan___como_realizar_uma_autocalibra__o_consciente', 5, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDK', 'Guia SERNISSAN | Plano de TransformaÃ§Ã£o', 'guia_sernissan___plano_de_transforma__o', 6, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDL', 'Guia SERNISSAN | ReuniÃ£o de Resultados', 'guia_sernissan___reuni_o_de_resultados', 7, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDP', 'Mapa de competÃªncias', 'mapa_de_compet_ncias', 8, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDV', 'Guia SERNISSAN | Passos da DemonstraÃ§Ã£o do VeÃ­culo', 'guia_sernissan___passos_da_demonstra__o_do_ve_culo', 11, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDW', 'Mapa de competÃªncias', 'mapa_de_compet_ncias0', 12, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDX', 'Trilha de integraÃ§Ã£o e desenvolvimento', 'trilha_de_integra__o_e_desenvolvimento', 13, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDd', 'Guia RÃ¡pido para o Armazenamento e Manuseio de VeÃ­culos Zero Km', 'guia_r_pido_para_o_armazenamento_e_manuseio_de_ve_culos_zero_km', 16, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDh', 'Manual de Manuseio do VeÃ­culo Novo_NVHM_2019', 'manual_de_manuseio_do_ve_culo_novo_nvhm_2019', 18, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDi', 'CartÃ£o de ApresentaÃ§Ã£o do PÃ³s-Venda', 'cart_o_de_apresenta__o_do_p_s_venda', 17, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDj', 'CartÃ£o de SatisfaÃ§Ã£o de PÃ³s-Venda', 'cart_o_de_satisfa__o_de_p_s_venda', 19, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDn', 'CatÃ¡logo de Ferramentas e Equipamentos Nissan 05_2023', 'cat_logo_de_ferramentas_e_equipamentos_nissan_05_2023', 20, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDu', 'Guia SERNISSAN | SessÃ£o Individual de Feedback e Planejamento de Performance', 'guia_sernissan___sess_o_individual_de_feedback_e_planejamento_de_performance', 24, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXDv', 'Guia SERNISSAN | PRC (Processo de RecuperaÃ§Ã£o de Clientes)', 'guia_sernissan__prc__processo_de_recupera__o_de_clientes_', 25, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIB', 'PreferÃªncias para a Entrega', 'prefer_ncias_para_a_entrega', 28, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIC', 'CartÃ£o Check-out de ServiÃ§o', 'cart_o_check_out_de_servi_o', 29, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXID', 'DPVN 110-23 Guia 2023 de AcessorizaÃ§Ã£o de VeÃ­culos para Showroom e Test Drive', 'dpvn_110_23_guia_2023_de_acessoriza__o_de_ve_culos_para_showroom_e_test_drive', 30, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIH', 'Guia SERNISSAN | Guia para IndicaÃ§Ãµes', 'guia_sernissan___guia_para_indica__es', 31, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXII', 'Guia SERNISSAN | NegociaÃ§Ã£o e Fechamento', 'guia_sernissan___negocia__o_e_fechamento', 32, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIJ', 'Guia SERNISSAN | Roteiro de Contato de Relacionamento e IndicaÃ§Ã£o', 'guia_sernissan___roteiro_de_contato_de_relacionamento_e_indica__o', 33, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIN', 'Guia SERNISSAN | Roteiro de RecuperaÃ§Ã£o de NegÃ³cios', 'guia_sernissan___roteiro_de_recupera__o_de_neg_cios', 34, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIZ', 'RevisÃ£o de Entrega 0KM', 'revis_o_de_entrega_0km', 40, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIl', 'Check-in-up-out de ServiÃ§os', 'check_in_up_out_de_servi_os', 41, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIm', 'Guia SERNISSAN | InventÃ¡rio e Estoque', 'guia_sernissan___invent_rio_e_estoque', 42, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIn', 'Guia SERNISSAN | Painel de Monitoramento de PeÃ§as Pendentes', 'guia_sernissan___painel_de_monitoramento_de_pe_as_pendentes', 43, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIr', 'Guia SERNISSAN | Passos da Coleta Antecipada de PeÃ§as', 'guia_sernissan___passos_da_coleta_antecipada_de_pe_as', 44, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIs', 'Painel de Monitoramento de PeÃ§as Pendentes', 'painel_de_monitoramento_de_pe_as_pendentes', 45, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXIt', 'ProgramaÃ§Ã£o de ServiÃ§os', 'programa__o_de_servi_os', 46, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXJo', 'Guia SERNISSAN | Roteiro de Contato de  Relacionamento e IndicaÃ§Ã£o', 'guia_sernissan___roteiro_de_contato_de__relacionamento_e_indica__o', 48, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXJp', 'Menu de RevisÃµes e ServiÃ§os', 'menu_de_revis_es_e_servi_os', 49, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXJv', 'Guia SERNISSAN | IdentificaÃ§Ã£o de VeÃ­culo De ServiÃ§o', 'guia_sernissan___identifica__o_de_ve_culo_de_servi_o', 52, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXJz', 'Guia SERNISSAN | Passos da ExecuÃ§Ã£o de ServiÃ§os', 'guia_sernissan___passos_da_execu__o_de_servi_os', 53, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXKA', 'Guia SERNISSAN | Passos da RevisÃ£o de ServiÃ§os', 'guia_sernissan___passos_da_revis_o_de_servi_os', 54, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXKG', 'Guia SERNISSAN | ProgramaÃ§Ã£o de ServiÃ§o', 'guia_sernissan___programa__o_de_servi_o', 57, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXKL', 'Guia SERNISSAN | Etiqueta de ServiÃ§o', 'guia_sernissan___etiqueta_de_servi_o', 59, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXKM', 'Guia SERNISSAN | Passos do Check-in de ServiÃ§os', 'guia_sernissan___passos_do_check_in_de_servi_os', 60, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXKN', 'Guia SERNISSAN | Passos do Check-out de ServiÃ§os', 'guia_sernissan___passos_do_check_out_de_servi_os', 61, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXKR', 'DQGN 006-23 Nissan Dealer Plus â€“ Processo de Garantia', 'dqgn_006_23_nissan_dealer_plus___processo_de_garantia', 62, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXKX', 'CartÃ£o Check-in de ServiÃ§o', 'cart_o_check_in_de_servi_o', 65, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_ferramenta', 'bTXKY', 'CartÃ£o Check-out de ServiÃ§o', 'cart_o_check_out_de_servi_o0', 66, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXFn', 'DesejÃ¡vel conhecimento de informÃ¡tica bÃ¡sica (Word e Excel).', 'desej_vel_conhecimento_de_inform_tica_b_sica__word_e_excel__', 2, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXFr', 'ExperiÃªncia na Ã¡rea comercial ou Administrativa.', 'experi_ncia_na__rea_comercial_ou_administrativa_', 3, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXFt', 'Conhecimento da Ã¡rea de geraÃ§Ã£o de relatÃ³rios do sistema de gestÃ£o da concessionÃ¡ria.', 'conhecimento_da__rea_de_gera__o_de_relat_rios_do_sistema_de_gest_o_da_concession_ria_', 5, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXFx', 'Indicadores de GestÃ£o.', 'indicadores_de_gest_o_', 6, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXFz', 'Conhecimento em informÃ¡tica bÃ¡sica (Word, Exc).', 'conhecimento_em_inform_tica_b_sica__word__excel__', 8, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGD', 'DesejÃ¡vel conhecimento das operaÃ§Ãµes financeiras.', 'desej_vel_conhecimento_das_opera__es_financeiras_', 9, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGF', 'Conhecimento da Ã¡rea de geraÃ§Ã£o de relatÃ³rios do sistema de gestÃ£o da concessionÃ¡ria.', 'conhecimento_da__rea_de_gera__o_de_relat_rios_do_sistema_de_gest_o_da_concession_ria_0', 11, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGJ', 'Conhecimento no mercado automobilÃ­stico.', 'conhecimento_no_mercado_automobil_stico_', 12, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGL', 'Vistoria de veÃ­culos.', 'vistoria_de_ve_culos_', 14, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGR', 'Conhecimento de tÃ©cnicas, acompanhamento e adminstraÃ§Ã£o de redes sociais.', 'conhecimento_de_t_cnicas__acompanhamento_e_adminstra__o_de_redes_sociais_', 17, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGV', 'Conhecimento de tÃ©cnicas de marketing digital e e-commerce.', 'conhecimento_de_t_cnicas_de_marketing_digital_e_e_commerce_', 18, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGW', 'Conhecimento dos processos internos de vendas da concessionÃ¡ria.', 'conhecimento_dos_processos_internos_de_vendas_da_concession_ria_', 19, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGX', 'DesejÃ¡vel conhecimento em matemÃ¡tica financeira.', 'desej_vel_conhecimento_em_matem_tica_financeira_', 20, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGc', 'DesejÃ¡vel conhecimento em matemÃ¡tica financeira.', 'desej_vel_conhecimento_em_matem_tica_financeira_0', 22, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGh', 'TÃ©cnicas de negociaÃ§Ã£o e apresentaÃ§Ã£o dos veÃ­culos Nissan (vantagens, caracterÃ­sticas e atributos).', 't_cnicas_de_negocia__o_e_apresenta__o_dos_ve_culos_nissan__vantagens__caracter_sticas_e_atributos__', 24, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGi', 'Processos internos de vendas da ConcessionÃ¡ria.', 'processos_internos_de_vendas_da_concession_ria_', 25, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGj', 'Conhecimento no mercado automobilÃ­stico, mais especificamente na legislaÃ§Ã£o que beneficia o cliente PCD.', 'conhecimento_no_mercado_automobil_stico__mais_especificamente_na_legisla__o_que_beneficia_o_cliente_pdc_', 26, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGo', 'ExperiÃªncia em vendas diretas a empresas e Ã³rgÃ£os oficiais no ramo automobilÃ­stico.', 'experi_ncia_em_vendas_diretas_a_empresas_e__rg_os_oficiais_no_ramo_automobil_stico_', 28, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGp', 'Conhecimento do Sistema de GestÃ£o da ConcessionÃ¡ria.', 'conhecimento_do_sistema_de_gest_o_da_concession_ria_', 29, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGt', 'Conhecimento dos diferenciais dos acessÃ³rios genuÃ­nos Nissan frente Ã  concorrÃªncia (paralelo).', 'conhecimento_dos_diferenciais_dos_acess_rios_genu_nos_nissan_frente___concorr_ncia__paralelo__', 30, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGv', 'Conhecimento da utilizaÃ§Ã£o dos atributos do carro.', 'conhecimento_da_utiliza__o_dos_atributos_do_carro_', 32, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXGz', 'Conhecimento em Vendas no segmento automobilÃ­stico.', 'conhecimento_em_vendas_no_segmento_automobil_stico_', 33, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXHA', 'Conhecimentos em informÃ¡tica (Pacote Office e internet).', 'conhecimentos_em_inform_tica__pacote_office__', 34, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXHB', 'Conhecimento em vendas diretas a empresas e Ã³rgÃ£os oficiais no mercado automobilÃ­stico.', 'conhecimento_em_vendas_diretas_a_empresas_e__rg_os_oficiais_no_mercado_automobil_stico_', 35, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXHF', 'Conhecimento de todo o processo digital de vendas da concessionÃ¡ria e da montadora.', 'conhecimento_de_todo_o_processo_digital_de_vendas_da_concession_ria_e_da_montadora_', 36, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXHG', 'Conhecimento em controles de preparaÃ§Ã£o de veÃ­culos e tempo de execuÃ§Ã£o.', 'conhecimento_em_controles_de_prepara__o_de_ve_culos_e_tempo_de_execu__o_', 37, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXHH', 'DesejÃ¡vel conhecimento de veÃ­culos.', 'desej_vel_conhecimento_de_ve_culos_', 38, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXHL', 'Conhecimento em controles de recebimento e armazenamento de veÃ­culos e tempos de execuÃ§Ã£o.', 'conhecimento_em_controles_de_recebimento_e_armazenamento_de_ve_culos_e_tempos_de_execu__o_', 39, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXHM', 'Conhecimento dos serviÃ§os bÃ¡sicos da ConcessionÃ¡ria e seus respectivos responsÃ¡veis.', 'conhecimento_dos_servi_os_b_sicos_da_concession_ria_e_seus_respectivos_respons_veis_', 40, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXHN', 'DesejÃ¡vel experiÃªncia anterior como telefonista', 'desej_vel_experi_ncia_anterior_como_telefonista', 41, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXIf', 'Conhecimento na Ã¡rea de peÃ§as de concessionÃ¡rias.', 'conhecimento_na__rea_de_pe_as_de_concession_rias_', 42, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXIg', 'Conhecimento em gestÃ£o de estoque.', 'conhecimento_em_gest_o_de_estoque_', 43, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXIy', 'Conhecimento da Ã¡rea de agendamento do Sistema de GestÃ£o da ConcessionÃ¡ria.', 'conhecimento_da__rea_de_agendamento_do_sistema_de_gest_o_da_concession_ria_', 44, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXIz', 'Conhecimento dos serviÃ§os oferecidos pela concessionÃ¡ria .', 'conhecimento_dos_servi_os_oferecidos_pela_concession_ria__', 45, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJD', 'DesejÃ¡vel ExperiÃªncia na Ã¡rea Administrativa.', 'desej_vel_experi_ncia_na__rea_administrativa_', 46, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJE', 'Conhecimento dos processo internos da Ã¡rea de PÃ³s-Venda.', 'conhecimento_dos_processo_internos_da__rea_de_p_s_venda_', 47, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJF', 'Conhecimento tÃ©cnico elevado em manutenÃ§Ã£o de veÃ­culos Nissan.', 'conhecimento_t_cnico_elevado_em_manuten__o_de_ve_culos_nissan_', 48, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJJ', 'Conhecimento dos processo de PÃ³s-Venda.', 'conhecimento_dos_processo_de_p_s_venda_', 49, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJL', 'Possuir CNH para realizaÃ§Ã£o de testes.', 'possuir_cnh_para_realiza__o_de_testes_', 51, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJP', 'DesejÃ¡vel conhecimento em mecÃ¢nica.', 'desej_vel_conhecimento_em_mec_nica_', 52, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJQ', 'Conhecimento tÃ©cnico em mecÃ¢nica.', 'conhecimento_t_cnico_em_mec_nica_', 53, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJR', 'Conhecimento dos processo chave de PÃ³s-Venda.', 'conhecimento_dos_processo_chave_de_p_s_venda_', 54, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJV', 'Conhecimento no mercado de reparo automobilÃ­stico.', 'conhecimento_no_mercado_de_reparo_automobil_stico_', 55, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJW', 'Conhecimento de tÃ©cnicas de garantia automotiva.', 'conhecimento_de_t_cnicas_de_garantia_automotiva_', 56, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJX', 'Conhecimento em instalaÃ§Ã£o de acessÃ³rios automotivos.', 'conhecimento_em_instala__o_de_acess_rios_automotivos_', 57, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJb', 'MÃ©todos de lavagem de veÃ­culos', 'm_todos_de_lavagem_de_ve_culos', 58, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJc', 'Processos de Vendas e PÃ³s-Venda relacionados Ã  lavagem', 'processos_de_vendas_e_p_s_venda_relacionados___lavagem', 59, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJd', 'Conhecimento tÃ©cnico em acessibilidade a equipamentos de diagnÃ³sticos.', 'conhecimento_t_cnico_em_acessibilidade_a_equipamentos_de_diagn_sticos_', 60, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXJh', 'Conhecimento elevado em manutenÃ§Ã£o de veÃ­culos Nissan.', 'conhecimento_elevado_em_manuten__o_de_ve_culos_nissan_', 61, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXKp', 'Conhecimento da parte de entrada de produtos e serviÃ§os e de emissÃ£o de notas do Sistema de GestÃ£o da ConcessionÃ¡ria.', 'conhecimento_da_parte_de_entrada_de_produtos_e_servi_os_e_de_emiss_o_de_notas_do_sistema_de_gest_o_da_concession_ria_', 62, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXKq', 'Conhecimento dos Produtos  serviÃ§os da ConcessionÃ¡ria.', 'conhecimento_dos_produtos__servi_os_da_concession_ria_', 63, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXKr', 'RelaÃ§Ã£o de documentos e comprovantes para emissÃ£o da Nota Fiscal.', 'rela__o_de_documentos_e_comprovantes_para_emiss_o_da_nota_fiscal_', 64, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXKw', 'Rotinas admistrativas da ConcessionÃ¡ria.', 'rotinas_admistrativas_da_concession_ria_', 66, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXKx', 'Todos os indicadores contÃ¡beis da ConcessionÃ¡ria.', 'todos_os_indicadores_cont_beis_da_concession_ria_', 67, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLB', 'Indicadores de Performance financeiros por Ã¡rea.', 'indicadores_de_performance_financeiros_por__rea_', 68, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLC', 'Conhecimento em Modelos de gestÃ£o de Marketing', 'conhecimento_em_modelos_de_gest_o_de_marketing', 69, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLD', 'Conhecimento dos processos chave de Vendas e PÃ³s-venda.', 'conhecimento_dos_processos_chave_de_vendas_e_p_s_venda_', 70, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLH', 'Conhecimento dos mÃ©todos das pesquisas de satisfaÃ§Ã£o.', 'conhecimento_dos_m_todos_das_pesquisas_de_satisfa__o_', 71, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLI', 'Conhecimento dos processos de recuperaÃ§Ã£o de Clientes.', 'conhecimento_dos_processos_de_recupera__o_de_clientes_', 72, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLN', 'DesejÃ¡vel conhecimento no segmento automobilÃ­stico.', 'desej_vel_conhecimento_no_segmento_automobil_stico_', 74, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLP', 'Conhecimento dos processos de Vendas e PÃ³s-venda.', 'conhecimento_dos_processos_de_vendas_e_p_s_venda_', 76, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLT', 'Conhecimento em Modelos de gestÃ£o.', 'conhecimento_em_modelos_de_gest_o_', 77, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLU', 'Conhecimento do Mapa de CompetÃªncias Nissan.', 'conhecimento_do_mapa_de_compet_ncias_nissan_', 78, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLV', 'Conhecimento do mapa de competÃªncias da ConcessionÃ¡ria.', 'conhecimento_do_mapa_de_compet_ncias_da_concession_ria_', 79, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLZ', 'Conhecimento de modelos de capacitaÃ§Ã£o (tÃ©cnica e comportamental).', 'conhecimento_de_modelos_de_capacita__o__t_cnica_e_comportamental__', 80, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLa', 'ExperiÃªncia na elaboraÃ§Ã£o e anÃ¡lise de demonstrativos contÃ¡beis.', 'experi_ncia_na_elabora__o_e_an_lise_de_demonstrativos_cont_beis_', 81, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLb', 'Conhecimento em legislaÃ§Ã£o fiscal e tributÃ¡ria.', 'conhecimento_em_legisla__o_fiscal_e_tribut_ria_', 82, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLf', 'ExperiÃªncia em implantaÃ§Ã£o e controle de rotinas administrativas.', 'experi_ncia_em_implanta__o_e_controle_de_rotinas_administrativas_', 83, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLg', 'DesejÃ¡vel conhecimento em processos de ISO 9000.', 'desej_vel_conhecimento_em_processos_de_iso_9000_', 84, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLm', 'Conhecimento bÃ¡sico dos canais de contato com Clientes', 'conhecimento_b_sico_dos_canais_de_contato_com_clientes', 87, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLn', 'ExperiÃªncia anterior em operaÃ§Ãµes de telemarketing.', 'experi_ncia_anterior_em_opera__es_de_telemarketing_', 88, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLr', 'DesejÃ¡vel conhecimento da estrutura organizacional de uma concessionÃ¡ria.', 'desej_vel_conhecimento_da_estrutura_organizacional_de_uma_concession_ria_', 89, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLs', 'Conhecimento de modelos de gestÃ£o de pessoas.', 'conhecimento_de_modelos_de_gest_o_de_pessoas_', 90, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLt', 'DesejÃ¡vel experiÃªncia anterior na Ã¡rea de SAC.', 'desej_vel_experi_ncia_anterior_na__rea_de_sac_', 91, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLx', 'Conhecimento do sistema Salesforce e processo de Vendas e PÃ³s-Venda.', 'conhecimento_do_sistema_salesforce_e_processo_de_vendas_e_p_s_venda_', 92, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXLy', 'Conhecimento no CÃ³digo de Defesa do Consumidor.', 'conhecimento_no_c_digo_de_defesa_do_consumidor_', 93, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXMD', 'Conhecimento de implementaÃ§Ã£o e manutenÃ§Ã£o de computadores em Redes.', 'conhecimento_de_implementa__o_e_manuten__o_de_computadores_em_redes_', 95, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXME', 'Conhecimento do sistema de gestÃ£o da ConcessionÃ¡ria.', 'conhecimento_do_sistema_de_gest_o_da_concession_ria_0', 96, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_conhecimentos', 'bTXMF', 'Conhecimento do sistema de gestÃ£o da ConcessionÃ¡ria.', 'conhecimento_do_sistema_de_gest_o_da_concession_ria_1', 97, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_tipo', 'bTWoX', 'EspecÃ­fica', 'espec_fica', 1, '{"divisor": 10}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_tipo', '1763437206769x474919464966719360', 'HÃ¡bito', 'h_bito', 3, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_tipo', '1763437476610x679996466691551440', 'HÃ¡bito', 'h_bito0', 4, '{"divisor": 70}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqc', 'SeleÃ§Ã£o e IntegraÃ§Ã£o', 'sele__o_e_integra__o', 3, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqd', 'Recursos e InstalaÃ§Ãµes', 'recursos_e_instala__es', 4, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqh', '1', '1_', 5, '{"mv": "MV 1", "id0": "CH1", "area": "I", "peso": 9, "trilha": 1, "pergunta": "Teve pessoas capacitadas para todas as FunÃ§Ãµes-Chave, direcionados ao Encantamento do Cliente?", "descricao": "Tenha pessoas capacitadas para todas as FunÃ§Ãµes-Chave, direcionados ao Encantamento do Cliente.", "essencial": true, "momento_de_verdade": "Estrutura das Equipes"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqi', '2', '2_', 6, '{"mv": "MV 2", "id0": "CH2", "area": "I", "peso": 1, "trilha": 1, "pergunta": "Realizou o recrutamento e seleÃ§Ã£o para contratar colaboradores adequados?", "descricao": "Realize o recrutamento e seleÃ§Ã£o para contratar colaboradores adequados.", "essencial": false, "momento_de_verdade": "SeleÃ§Ã£o e IntegraÃ§Ã£o"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqj', '3', '3_', 7, '{"mv": "MV 3", "id0": "CH3", "area": "I", "peso": 1, "trilha": 1, "pergunta": "Garantiu que todos os colaboradores utilizem os recursos necessÃ¡rios para o seu desempenho?", "descricao": "Garanta que todos os colaboradores utilizem os recursos necessÃ¡rios para o seu desempenho.", "essencial": false, "momento_de_verdade": "Recursos e InstalaÃ§Ãµes"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqn', '4', '4_', 8, '{"mv": "MV 3", "id0": "CH4", "area": "PV", "peso": 6, "trilha": 1, "pergunta": "Teve box equipados e ferramentas adequadas para a execuÃ§Ã£o dos serviÃ§os?", "descricao": "Possui boxes equipados e ferramentas adequadas para a execuÃ§Ã£o dos serviÃ§os.", "essencial": true, "momento_de_verdade": "Recursos e InstalaÃ§Ãµes"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqo', '5', '5_', 9, '{"mv": "MV 3", "id0": "CH5", "area": "I", "peso": 3, "trilha": 1, "pergunta": "Manteve as instalaÃ§Ãµes da ConcessionÃ¡ria em perfeitas condiÃ§Ãµes?", "descricao": "Mantenha as instalaÃ§Ãµes da ConcessionÃ¡ria em perfeitas condiÃ§Ãµes.", "essencial": false, "momento_de_verdade": "Recursos e InstalaÃ§Ãµes"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqt', '7', '7_', 11, '{"mv": "MV 4", "id0": "CH7", "area": "I", "peso": 6, "trilha": 1, "pergunta": "Desenvolveu continuamente os colaboradores com foco na alta performance?", "descricao": "Desenvolve e reconhece os colaboradores, por mÃ©rito ou bonificaÃ§Ã£o, com foco em alta performance.", "essencial": true, "momento_de_verdade": "Treinamento e Desenvolvimento"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqu', '8', '8_', 12, '{"mv": "MV 5", "id0": "CH8", "area": "I", "peso": 1, "trilha": 1, "pergunta": "Reconheceu e bonificou todos os colaboradores com foco na reduÃ§Ã£o da rotatividade?", "descricao": "Realize aÃ§Ãµes de melhoria continua.", "essencial": false, "momento_de_verdade": "Performance e Reconhecimento"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqv', '9', '9_', 13, '{"mv": "MV 6", "id0": "CH9", "area": "I", "peso": 6, "trilha": 1, "pergunta": "Realizou aÃ§Ãµes de melhoria contÃ­nua?", "descricao": "Realize aÃ§Ãµes de relacionamento e marketing.", "essencial": true, "momento_de_verdade": "Cultura Kaizen"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXqz', '10', '10_', 14, '{"mv": "MV 7", "id0": "CH10", "area": "I", "peso": 1, "trilha": 2, "pergunta": "Realizou aÃ§Ãµes de relacionamento e marketing?", "descricao": "Realize campanhas e aÃ§Ãµes de prospecÃ§Ã£o de Clientes.", "essencial": false, "momento_de_verdade": "AÃ§Ãµes de Relacionamento e Marketing"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrA', '11', '11_', 15, '{"mv": "MV 8", "id0": "CH11", "area": "I", "peso": 6, "trilha": 2, "pergunta": "Realizou campanhas e aÃ§Ãµes de prospecÃ§Ã£o de Clientes?", "descricao": "Posicione os veÃ­culos no showroom conforme recomendaÃ§Ã£o da Nissan.", "essencial": true, "momento_de_verdade": "AÃ§Ãµes de ProspecÃ§Ã£o"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrB', '12', '12_', 16, '{"mv": "MV 9", "id0": "CH12", "area": "V", "peso": 1, "trilha": 2, "pergunta": "Posicionou os veÃ­culos no showroom conforme recomendaÃ§Ã£o da Nissan?", "descricao": "Posicione os veÃ­culos no showroom conforme recomendaÃ§Ã£o da Nissan.", "essencial": false, "momento_de_verdade": "PreparaÃ§Ã£o para receber o Cliente de Vendas"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrG', '14', '14_', 18, '{"mv": "MV 11", "id0": "CH14", "area": "PV", "peso": 3, "trilha": 2, "pergunta": "Revisou a programaÃ§Ã£o do dia seguinte e assegurou a disponibilidade do Consultor de ServiÃ§os para receber os Clientes agendados?", "descricao": "Revise a programaÃ§Ã£o do dia seguinte e assegure a disponibilidade do Consultor de ServiÃ§os para receber os Clientes agendados.", "essencial": false, "momento_de_verdade": "PreparaÃ§Ã£o para receber o Cliente de PÃ³s-Vendas"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrH', '15', '15_', 19, '{"mv": "MV 12", "id0": "CH15", "area": "V", "peso": 3, "trilha": 3, "pergunta": "Teve uma pessoa ou central responsÃ¡vel pelo atendimento e registro dos Clientes Digitais?", "descricao": "Tenha uma pessoa ou central responsÃ¡vel pelo atendimento e registro dos Clientes Digitais.", "essencial": false, "momento_de_verdade": "Atendimento Clientes Digitais"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrL', '16', '16_', 20, '{"mv": "MV 13", "id0": "CH16", "area": "I", "peso": 1, "trilha": 3, "pergunta": "Teve um sistema efetivo de atendimento telefÃ´nico e de distribuiÃ§Ã£o das ligaÃ§Ãµes?", "descricao": "Tenha um sistema efetivo de atendimento telefÃ´nico e de distribuiÃ§Ã£o das ligaÃ§Ãµes.", "essencial": false, "momento_de_verdade": "Atendimento TelefÃ´nico"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrM', '17', '17_', 21, '{"mv": "MV 14", "id0": "CH17", "area": "I", "peso": 1, "trilha": 3, "pergunta": "Atendeu de forma Ã¡gil, cumprimentou pelo nome, confirmou a finalidade da visita e compartilhou os prÃ³ximos passos do atendimento?", "descricao": "Atenda de forma Ã¡gil, cumprimente pelo nome, confirme a finalidade da visita e compartilhe os prÃ³ximos passos do atendimento.", "essencial": false, "momento_de_verdade": "Atendimento Presencial"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrN', '18', '18_', 22, '{"mv": "MV 15", "id0": "CH18", "area": "V", "peso": 1, "trilha": 3, "pergunta": "Utilizou perguntas abertas, identificou o perfil do Cliente e explicou as caracterÃ­sticas e benefÃ­cios do veÃ­culo?", "descricao": "Utilize perguntas abertas, identifique o perfil do Cliente e explique as caracterÃ­sticas e benefÃ­cios do veÃ­culo.", "essencial": false, "momento_de_verdade": "QualificaÃ§Ã£o e ApresentaÃ§Ã£o do VeÃ­culo"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrR', '19', '19_', 23, '{"mv": "MV 16", "id0": "CH19", "area": "V", "peso": 6, "trilha": 3, "pergunta": "Teve um processo estruturado de Test Drive visando que o Cliente experimente completamente os recursos dos veÃ­culos?", "descricao": "Tenha um processo estruturado de Test Drive visando que o Cliente experimente completamente os recursos dos veÃ­culos?", "essencial": true, "momento_de_verdade": "Test Drive"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrS', '20', '20_', 24, '{"mv": "MV 17", "id0": "CH20", "area": "V", "peso": 1, "trilha": 3, "pergunta": "Manteve o processo Ã¡gil e transparente de avaliaÃ§Ã£o e captaÃ§Ã£o de veÃ­culos Seminovos?", "descricao": "Mantenha o processo Ã¡gil e transparente de avaliaÃ§Ã£o e captaÃ§Ã£o de veÃ­culos Seminovos.", "essencial": false, "momento_de_verdade": "AvaliaÃ§Ã£o do Seminovo"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrT', '21', '21_', 25, '{"mv": "MV 18", "id0": "CH21", "area": "V", "peso": 3, "trilha": 3, "pergunta": "Registrou imediatamente a negociaÃ§Ã£o no CRM/Sistema ao finalizar cada atendimento e garantiu a mediÃ§Ã£o da taxa de conversÃ£o?", "descricao": "Registre imediatamente a negociaÃ§Ã£o no CRM/Sistema ao finalizar cada atendimento e garanta a mediÃ§Ã£o da taxa de conversÃ£o.", "essencial": false, "momento_de_verdade": "NegociaÃ§Ã£o"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrX', '22', '22_', 26, '{"mv": "MV 19", "id0": "CH22", "area": "V", "peso": 1, "trilha": 3, "pergunta": "Teve um processo estruturado de recuperaÃ§Ã£o de negÃ³cios e acompanhamento dos Clientes que nÃ£o compraram?", "descricao": "Tenha um processo estruturado de recuperaÃ§Ã£o de negÃ³cios e acompanhamento dos Clientes que nÃ£o compraram.", "essencial": false, "momento_de_verdade": "RecuperaÃ§Ã£o de negÃ³cios e acompanhamento do Cliente"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrY', '23', '23_', 27, '{"mv": "MV 20", "id0": "CH23", "area": "V", "peso": 9, "trilha": 3, "pergunta": "Realizou o Check-in de Vendas para 100% dos Clientes presenciais e digitais, entendendo suas necessidades, gerando transparÃªncia no processo?", "descricao": "Realize o Check-in de Vendas para 100% dos Clientes presenciais e digitais, entendendo suas necessidades, gerando transparÃªncia no processo.", "essencial": true, "momento_de_verdade": "Fechamento e Check-in de Vendas"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrZ', '24', '24_', 28, '{"mv": "MV 21", "id0": "CH24", "area": "PV", "peso": 9, "trilha": 3, "pergunta": "Realizou o Check-in de ServiÃ§os com 100% dos Clientes no ND+ (Tablet de ServiÃ§os), registrando as suas necessidades e gerando transparÃªncia no processo?", "descricao": "Realize o Check-in de ServiÃ§os com 100% dos Clientes no ND+ (Tablet de ServiÃ§os), registrando as suas necessidades e gerando transparÃªncia no processo.", "essencial": true, "momento_de_verdade": "RecepÃ§Ã£o e Check-in de ServiÃ§os"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrd', '25', '25_', 29, '{"mv": "MV 22", "id0": "CH25", "area": "I", "peso": 1, "trilha": 3, "pergunta": "Teve um processo estruturado para a Venda de AcessÃ³rios?", "descricao": "Tenha um processo estruturado para a Venda de AcessÃ³rios.", "essencial": false, "momento_de_verdade": "Vendas de AcessÃ³rios, Nissan Protect e Agregados"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXre', '26', '26_', 30, '{"mv": "MV 23", "id0": "CH26", "area": "V", "peso": 3, "trilha": 4, "pergunta": "Teve um processo estruturado para garantir a transparÃªncia da negociaÃ§Ã£o e o contato com o Cliente?", "descricao": "Tenha um processo estruturado para garantir a transparÃªncia da negociaÃ§Ã£o e o contato com o Cliente?", "essencial": false, "momento_de_verdade": "GestÃ£o de Vendas"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrf', '27', '27_', 31, '{"mv": "MV 24", "id0": "CH27", "area": "V", "peso": 1, "trilha": 4, "pergunta": "Acompanhou a localizaÃ§Ã£o dos veÃ­culos, disponibilidade, tempo estimado de chegada e estoque atual?", "descricao": "Acompanhe a localizaÃ§Ã£o dos veÃ­culos, disponibilidade, tempo estimado de chegada e estoque atual.", "essencial": false, "momento_de_verdade": "PreparaÃ§Ã£o para Entrega de VeÃ­culos Novos"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrj', '28', '28_', 32, '{"mv": "MV 24", "id0": "CH28", "area": "I", "peso": 9, "trilha": 4, "pergunta": "Realizou a revisÃ£o do 0km e a instalaÃ§Ã£o acessÃ³rios, garantindo que o veÃ­culo esteja em perfeitas condiÃ§Ãµes?", "descricao": "Realize a revisÃ£o do 0km e a instalaÃ§Ã£o acessÃ³rios, garantindo que o veÃ­culo esteja em perfeitas condiÃ§Ãµes.", "essencial": true, "momento_de_verdade": "PreparaÃ§Ã£o para Entrega de VeÃ­culos Novos"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrk', '29', '29_', 33, '{"mv": "MV 25", "id0": "CH29", "area": "PV", "peso": 1, "trilha": 4, "pergunta": "Atualizou e compartilhou com os colaboradores envolvidos o Menu de RevisÃµes e ServiÃ§os (TMO) e a ProgramaÃ§Ã£o de ServiÃ§os?", "descricao": "Atualize e compartilhe com os colaboradores envolvidos o Menu de RevisÃµes e ServiÃ§os (TMO) e a ProgramaÃ§Ã£o de ServiÃ§os.", "essencial": false, "momento_de_verdade": "Planejamento e Controle dos ServiÃ§os"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrl', '30', '30_', 34, '{"mv": "MV 25", "id0": "CH30", "area": "PV", "peso": 1, "trilha": 4, "pergunta": "Localizou e identificou os veÃ­culos nas vagas operacionais e a etapa de serviÃ§o em que se encontram?", "descricao": "Localize e identifique os veÃ­culos nas vagas operacionais e a etapa de serviÃ§o em que se encontram.", "essencial": false, "momento_de_verdade": "Planejamento e Controle dos ServiÃ§os"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrp', '31', '31_', 35, '{"mv": "MV 26", "id0": "CH31", "area": "PV", "peso": 1, "trilha": 4, "pergunta": "Garantiu um estoque de peÃ§as eficiente e organizado, acompanhando giro e disponibilidade?", "descricao": "Garanta um estoque de peÃ§as eficiente e organizado, acompanhando giro e disponibilidade:", "essencial": false, "momento_de_verdade": "Estoque de PeÃ§as e AcessÃ³rios"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrq', '32', '32_', 36, '{"mv": "MV 26", "id0": "CH32", "area": "PV", "peso": 3, "trilha": 4, "pergunta": "Realizou gestÃ£o efetiva e comunicaÃ§Ã£o assertiva com os Clientes em todas as etapas do monitoramento dos pedidos de peÃ§as?", "descricao": "Realiza gestÃ£o efetiva e comunicaÃ§Ã£o assertiva com os Clientes em todas as etapas do monitoramento dos pedidos de peÃ§as?", "essencial": false, "momento_de_verdade": "Estoque de PeÃ§as e AcessÃ³rios"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrr', '33', '33_', 37, '{"mv": "MV 27", "id0": "CH33", "area": "PV", "peso": 1, "trilha": 4, "pergunta": "Garantiu que todos os TÃ©cnicos utilizem os recursos necessÃ¡rios para a execuÃ§Ã£o do serviÃ§o?", "descricao": "Garanta que todos os TÃ©cnicos utilizem os recursos necessÃ¡rios para a execuÃ§Ã£o do serviÃ§o.", "essencial": false, "momento_de_verdade": "ExecuÃ§Ã£o dos ServiÃ§os"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrv', '34', '34_', 38, '{"mv": "MV 27", "id0": "CH34", "area": "PV", "peso": 9, "trilha": 4, "pergunta": "Executou corretamente o ServiÃ§o, preenchendo com qualidade o Check-up de ServiÃ§os no ND+ (Tablet de ServiÃ§os)?", "descricao": "Execute corretamente o ServiÃ§o, preenchendo com qualidade o Check-up de ServiÃ§os no ND+ (Tablet de ServiÃ§os).", "essencial": true, "momento_de_verdade": "ExecuÃ§Ã£o dos ServiÃ§os"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrw', '35', '35_', 39, '{"mv": "MV 28", "id0": "CH35", "area": "PV", "peso": 3, "trilha": 4, "pergunta": "Garantiu a excelÃªncia na explicaÃ§Ã£o da necessidade de ServiÃ§o Adicional, utilizando o ND+ (Tablet de ServiÃ§os)?", "descricao": "Garanta a excelÃªncia na explicaÃ§Ã£o da necessidade de ServiÃ§o Adicional, utilizando o ND+ (Tablet de ServiÃ§os).", "essencial": false, "momento_de_verdade": "GestÃ£o do ServiÃ§o Adicional "}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXrx', '36', '36_', 40, '{"mv": "MV 29", "id0": "CH36", "area": "PV", "peso": 6, "trilha": 4, "pergunta": "Garantiu que 100% dos serviÃ§os tenham Controle de Qualidade?", "descricao": "Garanta que 100% dos serviÃ§os tenham Controle de Qualidade.", "essencial": true, "momento_de_verdade": "Controle de Qualidade"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsB', '37', '37_', 41, '{"mv": "MV 30", "id0": "CH37", "area": "I", "peso": 6, "trilha": 4, "pergunta": "Agendou e lavou com excelÃªncia os veÃ­culos em uma Ã¡rea exclusiva e adequada ao fluxo?", "descricao": "Agende e lave com excelÃªncia os veÃ­culos em uma Ã¡rea exclusiva e adequada ao fluxo.", "essencial": true, "momento_de_verdade": "Ãrea de Lavagem"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsC', '38', '38_', 42, '{"mv": "MV 31", "id0": "CH38", "area": "PV", "peso": 1, "trilha": 4, "pergunta": "Realizou corretamente e no prazo as Garantias?", "descricao": "Realize corretamente e no prazo as Garantias.", "essencial": false, "momento_de_verdade": "GestÃ£o de Garantia"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsD', '39', '39_', 43, '{"mv": "MV 32", "id0": "CH39", "area": "V", "peso": 6, "trilha": 5, "pergunta": "Teve um Preparador de Entrega que acompanhou todas as etapas e um Programador de Entrega que realizou o agendamento apenas quando o veÃ­culo estava pronto?", "descricao": "Tenha um Preparador de Entrega que acompanhe todas as etapas e um Programador de Entrega que realize o agendamento apenas quando o veÃ­culo estÃ¡ pronto.", "essencial": true, "momento_de_verdade": "ProgramaÃ§Ã£o de Entrega"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsH', '40', '40_', 44, '{"mv": "MV 33", "id0": "CH40", "area": "V", "peso": 3, "trilha": 5, "pergunta": "Realizou a inspeÃ§Ã£o final de entrega em atÃ© 2 horas antes do horÃ¡rio agendado e garantiu que estivesse em perfeitas condiÃ§Ãµes?", "descricao": "Realize a inspeÃ§Ã£o final de entrega em atÃ© 2 horas antes do horÃ¡rio agendado e garanta que esteja em perfeitas condiÃ§Ãµes.", "essencial": false, "momento_de_verdade": "InspeÃ§Ã£o Final de Vendas"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsI', '41', '41_', 45, '{"mv": "MV 34", "id0": "CH41", "area": "V", "peso": 9, "trilha": 5, "pergunta": "Criou uma experiÃªncia personalizada para o Cliente durante a Entrega do veÃ­culo (Check-out)?", "descricao": "Crie uma experiÃªncia personalizada para o Cliente durante a Entrega do veÃ­culo (Check-out).", "essencial": true, "momento_de_verdade": "Entrega do VeÃ­culo Novo (Check-out)"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsJ', '42', '42_', 46, '{"mv": "MV 34", "id0": "CH42", "area": "V", "peso": 1, "trilha": 5, "pergunta": "Realizou a Entrega do veÃ­culo novo dentro do prazo acordado com o Cliente, e cadastrou no GNB em atÃ© 24 horas?", "descricao": "Realize a Entrega do veÃ­culo novo dentro do prazo acordado com o Cliente, e cadastre no GNB em atÃ© 24 horas.", "essencial": false, "momento_de_verdade": "Entrega do VeÃ­culo Novo (Check-out)"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsN', '43', '43_', 47, '{"mv": "MV 35", "id0": "CH43", "area": "PV", "peso": 3, "trilha": 5, "pergunta": "Realizou a InspeÃ§Ã£o final de serviÃ§os para garantir que o veÃ­culo fosse entregue em perfeitas condiÃ§Ãµes?", "descricao": "Realize a InspeÃ§Ã£o final de serviÃ§os para garantir que o veÃ­culo seja entregue em perfeitas condiÃ§Ãµes.", "essencial": false, "momento_de_verdade": "InspeÃ§Ã£o Final de ServiÃ§os"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsO', '44', '44_', 48, '{"mv": "MV 36", "id0": "CH44", "area": "PV", "peso": 6, "trilha": 5, "pergunta": "Recebeu e direcionou o Cliente ao veÃ­culo utilizando o ND+ (Tablet de ServiÃ§os) e demonstrou visualmente os serviÃ§os executados e as peÃ§as substituÃ­das?", "descricao": "Receba e direcione o Cliente ao veÃ­culo utilizando o ND+ (Tablet de ServiÃ§os) e demonstre visualmente os serviÃ§os executados e as peÃ§as substituÃ­das.", "essencial": true, "momento_de_verdade": "InÃ­cio do Check-out de ServiÃ§os"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsP', '45', '45_', 49, '{"mv": "MV 36", "id0": "CH45", "area": "PV", "peso": 1, "trilha": 5, "pergunta": "Garantiu o prazo de Check-out combinado com o Cliente e realizou o Teste de Rodagem Final (quando necessÃ¡rio)?", "descricao": "Garanta o prazo de Check-out combinado com o Cliente e realize o Teste de Rodagem Final (quando necessÃ¡rio).", "essencial": false, "momento_de_verdade": "InÃ­cio do Check-out de ServiÃ§os"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsT', '46', '46_', 50, '{"mv": "MV 37", "id0": "CH46", "area": "PV", "peso": 9, "trilha": 5, "pergunta": "Explicou os serviÃ§os realizados, valores cobrados e obteve a assinatura do Cliente no Check-out no ND+ (Tablet de ServiÃ§os)?", "descricao": "Explique os serviÃ§os realizados, valores cobrados e obtenha a assinatura do Cliente no Check-out no ND+ (Tablet de ServiÃ§os).", "essencial": true, "momento_de_verdade": "ExplicaÃ§Ã£o da OS, valores e Check-out"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsU', '47', '47_', 51, '{"mv": "MV 38", "id0": "CH47", "area": "I", "peso": 3, "trilha": 6, "pergunta": "Garantiu a satisfaÃ§Ã£o do Cliente ainda na ConcessionÃ¡ria e informou sobre a Pesquisa Nissan?", "descricao": "Garanta a satisfaÃ§Ã£o do Cliente ainda na ConcessionÃ¡ria e informe sobre a Pesquisa Nissan.", "essencial": false, "momento_de_verdade": "InÃ­cio do acompanhamento da SatisfaÃ§Ã£o (Check-out)"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habito', 'bTXsa', '50', '50_', 54, '{"mv": "MV 41", "id0": "CH50", "area": "I", "peso": 3, "trilha": 6, "pergunta": "Realizou o PRC (Processo de recuperaÃ§Ã£o de Clientes) dentro de 24 horas em todos os canais?", "descricao": "Realize o PRC (Processo de recuperaÃ§Ã£o de Clientes) dentro de 24 horas em todos os canais.", "essencial": false, "momento_de_verdade": "Processo de RecuperaÃ§Ã£o de Cliente (PRC)"}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXDz', 'Ser responsÃ¡vel pela gestÃ£o do fluxo de loja da concessionÃ¡ria e excelÃªncia na recepÃ§Ã£o dos Clientes. Realizar o primeiro atendimento na Ã¡rea de vendas, registrando os dados dos clientes e direcionando-os aos Consultores de Vendas, Entregadores e outros setores.', 'ser_respons_vel_pela_gest_o_do_fluxo_de_loja_da_concession_ria_e_excel_ncia_na_recep__o_dos_clientes__realizar_o_primeiro_atendimento_na__rea_de_vendas__registrando_os_dados_dos_clientes_e_direcionando_os_aos_consultores_de_vendas__entregadores_e_outros_setores_', 1, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEA', 'ResponsÃ¡vel por dar suporte Ã  lideranÃ§a e aos Consultores de Vendas.', 'respons_vel_por_dar_suporte___lideran_a_e_aos_consultores_de_vendas_', 2, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEB', 'Organizar e acompanhar os processos da Ã¡rea, sendo o ponto focal de comunicaÃ§Ã£o com o Cliente para o faturamento dos pedidos.', 'organizar_e_acompanhar_os_processos_da__rea__sendo_o_ponto_focal_de_comunica__o_com_o_cliente_para_o_faturamento_dos_pedidos_', 3, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEF', 'ResponsÃ¡vel por dar suporte Ã  equipe de Vendas Diretas, auxiliar na organizaÃ§Ã£o e andamento dos processos da Ã¡rea, acompanhamento dos pedidos de veÃ­culos junto a montadora e documentaÃ§Ã£o necessÃ¡ria (cartas de isenÃ§Ã£o / prazos de validade) para faturamento.', 'respons_vel_por_dar_suporte___equipe_de_vendas_diretas__auxiliar_na_organiza__o_e_andamento_dos_processos_da__rea__acompanhamento_dos_pedidos_de_ve_culos_junto_a_montadora_e_documenta__o_necess_ria__cartas_de_isen__o___prazos_de_validade__para_faturamento_', 4, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEG', 'Avaliar os veÃ­culos usados oferecidos em troca por veÃ­culos novos ou usados da concessionÃ¡ria.', 'avaliar_os_ve_culos_usados_oferecidos_em_troca_por_ve_culos_novos_ou_usados_da_concession_ria_', 5, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEH', 'Ser o responsÃ¡vel pelo recebimento do veÃ­culo seminovo avaliado no momento da entrega do veÃ­culo adquirido pelo cliente.', 'ser_o_respons_vel_pelo_recebimento_do_ve_culo_seminovo_avaliado_no_momento_da_entrega_do_ve_culo_adquirido_pelo_cliente_', 6, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEL', 'Atender aos objetivos de vendas de veÃ­culos, realizando o atendimento, acompanhamento e conversÃ£o de Clientes Digitais (leads), garantindo 100% deles respondidos com foco na experiÃªncia do Cliente e qualificados com agilidade e clareza, contribuindo para a lucratividade, satisfaÃ§Ã£o e recomendaÃ§Ãµes.', 'atender_aos_objetivos_de_vendas_de_ve_culos__realizando_o_atendimento__acompanhamento_e_convers_o_de_clientes_digitais__leads___garantindo_100__deles_respondidos_com_foco_na_experi_ncia_do_cliente_e_qualificados_com_agilidade_e_clareza__contribuindo_para_a_lucratividade__satisfa__o_e_recomenda__es_', 7, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEM', 'Conhecer e utilizar tÃ©cnicas de marketing digital, rede sociais e e-commerce. Acompanhar e analisar os resultados dessas aÃ§Ãµes atravÃ©s das mÃ©tricas, visando refinar e ajustar as aÃ§Ãµes de forma Ã¡gil.', 'conhecer_e_utilizar_t_cnicas_de_marketing_digital__rede_sociais_e_e_commerce__acompanhar_e_analisar_os_resultados_dessas_a__es_atrav_s_das_m_tricas__visando_refinar_e_ajustar_as_a__es_de_forma__gil_', 8, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEN', 'Oferecer a melhor soluÃ§Ã£o financeira e produtos adicionais aos clientes, contribuindo para a lucratividade e efetivaÃ§Ã£o dos negÃ³cios.', 'oferecer_a_melhor_solu__o_financeira_e_produtos_adicionais_aos_clientes__contribuindo_para_a_lucratividade_e_efetiva__o_dos_neg_cios_', 9, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXER', 'Atender aos objetivos de vendas de veÃ­culos seminovos, dos produtos e agregados (acessÃ³rios, financiamento, seguro e documentaÃ§Ã£o), contribuindo para a lucratividade e garantindo a satisfaÃ§Ã£o total do Cliente.', 'atender_aos_objetivos_de_vendas_de_ve_culos_seminovos__dos_produtos_e_agregados__acess_rios__financiamento__seguro_e_documenta__o___contribuindo_para_a_lucratividade_e_garantindo_a_satisfa__o_total_do_cliente_', 10, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXES', 'Contribuir com os objetivos do Nissan Move e para a lucratividade da operaÃ§Ã£o.', 'contribuir_com_os_objetivos_do_nissan_move_e_para_a_lucratividade_da_opera__o_', 11, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXET', 'Realizar atendimentos no showroom, visitas externas e aÃ§Ãµes de prospecÃ§Ã£o para captaÃ§Ã£o de novas oportunidades.', 'realizar_atendimentos_no_showroom__visitas_externas_e_a__es_de_prospec__o_para_capta__o_de_novas_oportunidades_', 12, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEX', 'Dominar todos os processos especÃ­ficos de atendimento e negociaÃ§Ã£o do Nissan Move.', 'dominar_todos_os_processos_espec_ficos_de_atendimento_e_negocia__o_do_nissan_move_', 13, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEY', 'Proporcionar excelente experiÃªncia no acompanhamento de todas as etapas, principalmente a Entrega (Check-out), garantindo a total satisfaÃ§Ã£o dos Clientes.', 'proporcionar_excelente_experi_ncia_no_acompanhamento_de_todas_as_etapas__principalmente_a_entrega__check_out___garantindo_a_total_satisfa__o_dos_clientes_', 14, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEZ', 'Atender aos objetivos de vendas de veÃ­culos e agregados (acessÃ³rios originais, financiamentos, seguros e consÃ³rcio), contribuindo para a lucratividade e garantindo a satisfaÃ§Ã£o total dos Clientes. Dominar todos os processos de atendimento (fluxo de loja, telefone e leads), negociaÃ§Ã£o e processo de entrega dos veÃ­culos.', 'atender_aos_objetivos_de_vendas_de_ve_culos_e_agregados__acess_rios_originais__financiamentos__seguros_e_cons_rcio___contribuindo_para_a_lucratividade_e_garantindo_a_satisfa__o_total_dos_clientes__dominar_todos_os_processos_de_atendimento__fluxo_de_loja__telefone_e_leads___negocia__o_e_processo_de_entrega_dos_ve_culos_', 15, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEd', 'Atender aos objetivos de Vendas PCD e agregados e satisfaÃ§Ã£o do Cliente, contribuindo para o aumento do retorno, indicaÃ§Ã£o e lucratividade. Conhecimento sobre a legislaÃ§Ã£o pertinente, adaptaÃ§Ãµes de veÃ­culos, Entrega e Venda Direta. Realizar visitas externas para captaÃ§Ã£o de novas oportunidades.', 'atender_aos_objetivos_de_vendas_pcd_e_agregados_e_satisfa__o_do_cliente__contribuindo_para_o_aumento_do_retorno__indica__o_e_lucratividade__conhecimento_sobre_a_legisla__o_pertinente__adapta__es_de_ve_culos__entrega_e_venda_direta__realizar_visitas_externas_para_capta__o_de_novas_oportunidades_', 16, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEe', 'Atender aos objetivos de Vendas Direta, agregados, contribuindo para a lucratividade e garantindo a satisfaÃ§Ã£o total dos Clientes.', 'atender_aos_objetivos_de_vendas_direta__agregados__contribuindo_para_a_lucratividade_e_garantindo_a_satisfa__o_total_dos_clientes_', 17, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEf', 'Realizar visitas externas para captaÃ§Ã£o de novas oportunidades e dominar todos os processos especÃ­ficos de atendimento para Venda Direta (LicitaÃ§Ãµes, Frotas, Locadoras, TÃ¡xis, PCD e Produtor Rural), negociaÃ§Ã£o e entrega dos veÃ­culos.', 'realizar_visitas_externas_para_capta__o_de_novas_oportunidades_e_dominar_todos_os_processos_espec_ficos_de_atendimento_para_venda_direta__licita__es__frotas__locadoras__t_xis__pcd_e_produtor_rural___negocia__o_e_entrega_dos_ve_culos_', 18, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEj', 'Atender aos objetivos de vendas de acessÃ³rios originais nas Ã¡reas de vendas de novos, usados e assistÃªncia tÃ©cnica. Contribuindo para a lucratividade, garantindo a satisfaÃ§Ã£o total dos Clientes e acompanhando a disponibilidade e instalaÃ§Ã£o dos produtos.', 'atender_aos_objetivos_de_vendas_de_acess_rios_originais_nas__reas_de_vendas_de_novos__usados_e_assist_ncia_t_cnica__contribuindo_para_a_lucratividade__garantindo_a_satisfa__o_total_dos_clientes_e_acompanhando_a_disponibilidade_e_instala__o_dos_produtos_', 19, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEk', 'Realizar a entrega TÃ©cnica dos veÃ­culos, garantido que os clientes recebam todas as explicaÃ§Ãµes relacionadas ao VeÃ­culo, acessÃ³rios instalados, Manual de Garantia e documentos.', 'realizar_a_entrega_t_cnica_dos_ve_culos__garantido_que_os_clientes_recebam_todas_as_explica__es_relacionadas_ao_ve_culo__acess_rios_instalados__manual_de_garantia_e_documentos_', 20, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEl', 'Garantir os objetivos de venda de veÃ­culos seminovos e usados, com rentabilidade e venda de agregados (acessÃ³rios, financiamento, seguro e documentaÃ§Ã£o), garantindo a qualidade do atendimento, a satisfaÃ§Ã£o e a fidelizaÃ§Ã£o dos Clientes, suportando e facilitando Ã  venda dos veÃ­culos novos.', 'garantir_os_objetivos_de_venda_de_ve_culos_seminovos_e_usados__com_rentabilidade_e_venda_de_agregados__acess_rios__financiamento__seguro_e_documenta__o___garantindo_a_qualidade_do_atendimento__a_satisfa__o_e_a_fideliza__o_dos_clientes__suportando_e_facilitando___venda_dos_ve_culos_novos_', 21, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEp', 'Promover a gestÃ£o da equipe de Vendas garantindo os objetivos de venda de veÃ­culos novos, seminovos e usados em relaÃ§Ã£o ao volume, rentabilidade, e venda de agregados (acessÃ³rios, financiamento, seguro e emplacamento), garantindo a qualidade do atendimento, a satisfaÃ§Ã£o e a fidelizaÃ§Ã£o dos Clientes.', 'promover_a_gest_o_da_equipe_de_vendas_garantindo_os_objetivos_de_venda_de_ve_culos_novos__seminovos_e_usados_em_rela__o_ao_volume__rentabilidade__e_venda_de_agregados__acess_rios__financiamento__seguro_e_emplacamento___garantindo_a_qualidade_do_atendimento__a_satisfa__o_e_a_fideliza__o_dos_clientes_', 22, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEq', 'Promover a gestÃ£o da equipe de Vendas Diretas buscando atingir os objetivos de volume da Ã¡rea, venda de agregados (acessÃ³rios, financiamento, seguro e emplacamento) e rentabilidade,  garantindo a qualidade do atendimento, a satisfaÃ§Ã£o e a fidelizaÃ§Ã£o dos Clientes de Vendas Diretas.', 'promover_a_gest_o_da_equipe_de_vendas_diretas_buscando_atingir_os_objetivos_de_volume_da__rea__venda_de_agregados__acess_rios__financiamento__seguro_e_emplacamento__e_rentabilidade___garantindo_a_qualidade_do_atendimento__a_satisfa__o_e_a_fideliza__o_dos_clientes_de_vendas_diretas_', 23, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEr', 'Acompanhar todo processo de recebimento, tratamento e conversÃ£o de Clientes Digitais (leads), garantindo que 100% deles sejam avaliados e devidamente distribuÃ­dos Ã  forÃ§a de vendas.', 'acompanhar_todo_processo_de_recebimento__tratamento_e_convers_o_de_clientes_digitais__leads___garantindo_que_100__deles_sejam_avaliados_e_devidamente_distribu_dos___for_a_de_vendas_', 24, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEv', 'Realizar, checar e acompanhar todo o processo de recebimento, preparaÃ§Ã£o e deslocamento dos veÃ­culos atÃ© o momento da entrega, garantindo com que estejam em perfeitas condiÃ§Ãµes.', 'realizar__checar_e_acompanhar_todo_o_processo_de_recebimento__prepara__o_e_deslocamento_dos_ve_culos_at__o_momento_da_entrega__garantindo_com_que_estejam_em_perfeitas_condi__es_', 25, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEw', 'Coordenar a agenda de entregas e acompanhar a preparaÃ§Ã£o dos veÃ­culos de acordo com a data acordada com o cliente.', 'coordenar_a_agenda_de_entregas_e_acompanhar_a_prepara__o_dos_ve_culos_de_acordo_com_a_data_acordada_com_o_cliente_', 26, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXEx', 'Suportar a gestÃ£o da equipe de Vendas garantindo os objetivos de venda de veÃ­culos novos, seminovos e usados em relaÃ§Ã£o ao volume, rentabilidade, e venda de agregados (acessÃ³rios, financiamento, seguro e emplacamento), garantindo a qualidade do atendimento, a satisfaÃ§Ã£o e a fidelizaÃ§Ã£o dos Clientes.', 'suportar_a_gest_o_da_equipe_de_vendas_garantindo_os_objetivos_de_venda_de_ve_culos_novos__seminovos_e_usados_em_rela__o_ao_volume__rentabilidade__e_venda_de_agregados__acess_rios__financiamento__seguro_e_emplacamento___garantindo_a_qualidade_do_atendimento__a_satisfa__o_e_a_fideliza__o_dos_clientes_', 27, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXFB', 'Realizar o recebimento de veÃ­culos 0Km, armazenamento e a organizaÃ§Ã£o do PÃ¡tio, garantido os procedimentos conforme recomendaÃ§Ãµes da Nissan.', 'realizar_o_recebimento_de_ve_culos_0km__armazenamento_e_a_organiza__o_do_p_tio__garantido_os_procedimentos_conforme_recomenda__es_da_nissan_', 28, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXFC', 'Atender 100% das chamadas recebidas com excelÃªncia (rapidez e qualidade),  direcionando para as Ã¡reas e/ou pessoas solicitadas, organizando e controlando o fluxo de ligaÃ§Ãµes.', 'atender_100__das_chamadas_recebidas_com_excel_ncia__rapidez_e_qualidade____direcionando_para_as__reas_e_ou_pessoas_solicitadas__organizando_e_controlando_o_fluxo_de_liga__es_', 29, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXIa', 'Atender as solicitaÃ§Ãµes de peÃ§as realizadas pela oficina e balcÃ£o pÃºblico alÃ©m de contribuir com formaÃ§Ã£o dos pedidos junto Ã  montadora.', 'atender_as_solicita__es_de_pe_as_realizadas_pela_oficina_e_balc_o_p_blico_al_m_de_contribuir_com_forma__o_dos_pedidos_junto___montadora_', 30, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_para_que', 'bTXIb', 'Receber, armazenar e disponibilizar as peÃ§as com agilidade. Manter o estoque organizado e sistema atualizado com a quantidade correta de itens fÃ­sicos.', 'receber__armazenar_e_disponibilizar_as_pe_as_com_agilidade__manter_o_estoque_organizado_e_sistema_atualizado_com_a_quantidade_correta_de_itens_f_sicos_', 31, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHR', 'ExcelÃªncia no Atendimento ao Cliente', 'excel_ncia_no_atendimento_ao_cliente', 1, '{"id0": "CH1"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHS', 'GestÃ£o de Conflitos', 'gest_o_de_conflitos', 2, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHT', 'ConstruÃ§Ã£o de relatÃ³rios gerenciais', 'constru__o_de_relat_rios_gerenciais', 3, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHX', 'GestÃ£o de Processos', 'gest_o_de_processos', 4, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHY', 'GestÃ£o do Tempo', 'gest_o_do_tempo', 5, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHZ', 'Saber dirigir (possuir CNH vÃ¡lida)', 'saber_dirigir__possuir_cnh_v_lida_', 6, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHf', 'ExcelÃªncia no Atendimento ao Cliente', 'excel_ncia_no_atendimento_ao_cliente0', 9, '{}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHj', 'PersuasÃ£o', 'persuas_o', 10, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHk', 'GestÃ£o Financeira e de Indicadores', 'gest_o_financeira_e_de_indicadores', 11, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHp', 'AnÃ¡lise de CenÃ¡rios', 'an_lise_de_cen_rios', 13, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXHr', 'GestÃ£o de Recursos', 'gest_o_de_recursos', 15, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXIh', 'ConstruÃ§Ã£o de Campanhas', 'constru__o_de_campanhas', 16, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXJi', 'GestÃ£o de Pessoas', 'gest_o_de_pessoas', 17, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('competencia_habilidade', 'bTXJj', 'NegociaÃ§Ã£o', 'negocia__o', 18, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('icones', 'bTHAH', 'trofÃ©u', 'trof_u', 2, '{"svg": "//06fcf5899dd3f3daf85b97ec54edb9eb.cdn.bubble.io/f1719346988675x747924339874472300/Placar.svg"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('icones', 'bTHAI', 'comentÃ¡rio', 'coment_rio', 3, '{"svg": "//06fcf5899dd3f3daf85b97ec54edb9eb.cdn.bubble.io/f1719347027164x177137820345139500/Comment.svg"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('icones', 'bTHAP', 'calendÃ¡rio', 'calend_rio', 7, '{"svg": "//06fcf5899dd3f3daf85b97ec54edb9eb.cdn.bubble.io/f1719347143994x569714672135760640/Captions.svg"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('icones', 'bTHAh', 'usuÃ¡rio', 'usu_rio', 18, '{"svg": "//06fcf5899dd3f3daf85b97ec54edb9eb.cdn.bubble.io/f1719347466002x336525260699362940/user.svg"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('destacar_opcoes', 'bTQdd', 'NÃ£o atingiu', 'n_o_atingiu', 2, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('meses', 'bTMUP', 'MarÃ§o', 'mar_o', 3, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('log_type', 'bTVpt', 'UsuÃ¡rio', 'user', 1, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('log_type', 'bTVqR', 'ConcessionÃ¡ria', 'concession_ria', 3, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('log_type', 'bTVqS', 'DivisÃ£o', 'divis_o', 4, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('log_type', 'bTVqT', 'PaÃ­s', 'pa_s', 5, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('log_type', 'bTVrD', 'SolicitaÃ§Ã£o', 'solicita__o', 9, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('importancias', 'bTLti', 'MÃ©dio', 'media', 2, '{"pontos": 20}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('ndp_data', '1769436676197x596566327589985500', '03', '03_', 3, '{"m_s": "MarÃ§o"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('opcoes_api', '1766989756112x872928058316297500', 'ConcessionÃ¡ria', 'bir', 4, '{"tipo": "origem"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('ordenar_equipe', 'bTRHd', 'Ãrea', 'area', 2, '{"campo": "area", "crescente": false}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('ordenar_equipe', 'bTRHe', 'FunÃ§Ã£o', 'fun__o', 3, '{"campo": "funcao", "crescente": false}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('unidade', 'bTLxF', 'NÃºmero', 'numero0', 4, '{"simbolo": "#"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('unidade', 'bTMiT', 'S/N', 'v_ou_f', 5, '{"simbolo": "âœ“"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('site_options', '1777624956566x961950507366158200', 'ilustraÃ§Ã£o PDF', 'ilustra__o_pdf', 4, '{"image": "//06fcf5899dd3f3daf85b97ec54edb9eb.cdn.bubble.io/f1777657499799x531644167384926600/pdf-ilustration.png"}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('site_options', '1778091213582x841785304842359000', 'Video IntegraÃ§Ãµes VOC', 'video_integra__es_voc', 5, '{"text": "https://06fcf5899dd3f3daf85b97ec54edb9eb.cdn.bubble.io/f1778092553359x452338741727707840/Integra%C3%A7%C3%B5es_VOC.mp4?_gl=1*1lm1obu*_gcl_au*MjEwMDI0NzYxNS4xNzc1NjA5MTEx*_ga*NDE2MTA5MDYzLjE3NzUyNzI4MTU.*_ga_BFPVR2DEE2*czE3NzgwODk2ODckbzEwJGcxJHQxNzc4MDkyNTg5JGo2MCRsMCRoMA.."}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('site_options', '1778091248023x383685634982068300', 'Video IntegraÃ§Ãµes Dados de vendas', 'video_integra__es_dados_de_vendas', 6, '{"text": "https://06fcf5899dd3f3daf85b97ec54edb9eb.cdn.bubble.io/f1778092569574x242797240994396380/Integra%C3%A7%C3%B5es%20Dados%20de%20Vendas%20Nissan.mp4?_gl=1*15q5kv5*_gcl_au*MjEwMDI0NzYxNS4xNzc1NjA5MTEx*_ga*NDE2MTA5MDYzLjE3NzUyNzI4MTU.*_ga_BFPVR2DEE2*czE3NzgwODk2ODckbzEwJGcxJHQxNzc4MDkyNjIzJGoyNiRsMCRoMA.."}'::jsonb, true) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('tipo_de_instru__o', '1779741919378x518647753238956600', 'Mapa de CompetÃªncias', 'mapa_de_compet_ncias', 1, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('solicitacoes_opcoes', 'bTPtq', 'PaÃ­s', 'pa_s', 2, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
...
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('solicitacoes_opcoes', 'bTPtv', 'DivisÃ£o', 'divis_o', 4, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
insert into public.app_options (option_set, key, label, db_value, sort_order, metadata, is_deleted) values ('solicitacoes_opcoes', 'bTPtw', 'ConcessionÃ¡ria', 'concession_ria', 5, '{}'::jsonb, false) on conflict (option_set, key) do update set label=excluded.label, db_value=excluded.db_value, sort_order=excluded.sort_order, metadata=excluded.metadata, is_deleted=excluded.is_deleted;
