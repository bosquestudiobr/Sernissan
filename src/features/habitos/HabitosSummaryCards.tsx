import type { HabitosSummary } from '@/server/queries/habitos'

type HabitosSummaryCardsProps = {
  summary: HabitosSummary
}

export function HabitosSummaryCards({ summary }: HabitosSummaryCardsProps) {
  const items = [
