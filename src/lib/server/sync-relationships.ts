...
export async function syncJoinTable(
  supabase: DbClient,
  table: 'pais_divisoes' | 'divisao_setores' | 'grupo_concessionarias' | 'profiles_grupos_disponiveis' | 'profiles_concessionarias_equipe' | 'profiles_areas_disponiveis' | 'indicadores_areas' | 'indicadores_funcoes' | 'placar_indicadores' | 'concessionaria_placars' | 'competencia_mapa_habitos',
  parentKey: string,
  parentId: string,
  childKey: string,
